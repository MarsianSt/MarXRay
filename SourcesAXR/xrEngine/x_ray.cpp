...
ENGINE_API bool bWeatherTonemap = false;
ENGINE_API bool bWeatherSunLumscale = false;
...
void InitSettings()
{
	...
	bWeatherTonemap = READ_IF_EXISTS(pAdvancedSettings, r_bool, "environment", "weather_tonemap", false);
	bWeatherSunLumscale = READ_IF_EXISTS(pAdvancedSettings, r_bool, "environment", "weather_sun_lumscale", false);
