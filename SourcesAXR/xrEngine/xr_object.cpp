...
Fvector CObject::Center					()				const	{ Fvector result; VERIFY2(renderable.visual, *cName()); renderable.xform.transform_tiny(result, renderable.visual->getVisData().sphere.P); return result; }
