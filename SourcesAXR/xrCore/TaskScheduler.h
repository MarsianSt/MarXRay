...
namespace enki
{
    ...
    public:
              ...
              Dependency(    const ICompletable* pDependencyTask_, ICompletable* pTaskToRunOnCompletion_ );
              ~Dependency();

         void SetDependency( const ICompletable* pDependencyTask_, ICompletable* pTaskToRunOnCompletion_ );
    ...
    // ������� DefaultAllocFunc � DefaultFreeFunc

    struct CustomAllocator
    {
        AllocFunc alloc = EnkiAllocFunc; // ���������� ���� �������
        FreeFunc  free = EnkiFreeFunc;  // ���������� ���� �������
    ...
    public:
        ...
        // should only be called from main thread, or within a task
         void            AddTaskSetToPipe( ITaskSet* pTaskSet_ );
        ...
        // at initialization time.
         bool            RegisterExternalTaskThread();
    ...
    private:
        ...
        void        InitDependencies( ICompletable* pCompletable_  );
         void TaskComplete( ICompletable* pTask_, bool bWakeThreads_, uint32_t threadNum_ );
         void AddTaskSetToPipeInt( ITaskSet* pTaskSet_, uint32_t threadNum_ );
         void AddPinnedTaskInt( IPinnedTask* pTask_ );
