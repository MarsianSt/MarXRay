...
#ifndef MASTER_GOLD
			LogInfo("! ERROR: invalid 'blowout_particles_time' in '%s'",section);
...
#ifndef MASTER_GOLD
			LogInfo("! ERROR: invalid 'blowout_light_time' in '%s'",section);
#endif // #ifndef MASTER_GOLD
		}
	}
	else
...
#ifndef MASTER_GOLD
			LogInfo("! ERROR: invalid 'blowout_sound_time' in '%s'",section);
#endif // #ifndef MASTER_GOLD
		}
	}
	else
...
#ifndef MASTER_GOLD
			LogInfo("! ERROR: invalid 'blowout_explosion_time' in '%s'",section);
#endif // #ifndef MASTER_GOLD
		}
	}
	else
...
#ifndef MASTER_GOLD
			LogInfo("! ERROR: invalid 'blowout_wind_time_end' in '%s'",section);
#endif // #ifndef MASTER_GOLD
		}
