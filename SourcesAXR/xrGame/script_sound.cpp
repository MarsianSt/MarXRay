...
//	LogInfo("%6d : CScriptSound::Play (%s), delay %f, flags %d",Device.dwTimeGlobal,m_sound._handle()->file_name(),delay,flags);
...
{
	THROW3						(m_sound._handle(),"There is no sound",*m_caSoundToPlay);
//	LogInfo("%6d : CScriptSound::Play (%s), delay %f, flags %d",m_sound._handle()->file_name(),delay,flags);
