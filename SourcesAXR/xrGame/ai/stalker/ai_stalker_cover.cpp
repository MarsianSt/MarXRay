...
{
#ifdef _DEBUG
//	LogInfo("* [%6d][%s] search for new cover performed",Device.dwTimeGlobal,*cName());
#endif
#ifdef _DEBUG
...
//		m_best_cover_actual				= false;
//		LogInfo("* [%6d][%s] cover became too bad2",Device.dwTimeGlobal,*cName());
//		return;
//	}
...
#ifdef _DEBUG
//	LogInfo("* [%6d][%s] advance search performed",Device.dwTimeGlobal,*cName());
#endif
#ifdef _DEBUG
...
void CAI_Stalker::on_restrictions_change			()
{
	...
	m_best_cover_actual					= false;
#ifdef _DEBUG
	LogInfo("* [%6d][%s] on_restrictions_change",Device.dwTimeGlobal,*cName());
#endif
}
...
void CAI_Stalker::on_enemy_change					(const CEntityAlive *enemy)
{
	...
	m_best_cover_actual					= false;
#ifdef _DEBUG
//	LogInfo("* [%6d][%s] on_enemy_change",Device.dwTimeGlobal,*cName());
#endif
}
...
#ifdef _DEBUG
//		LogInfo("* [%6d][%s] on_danger_add",Device.dwTimeGlobal,*cName());
#endif
		m_best_cover_actual				= false;
	}
}
...
#ifdef _DEBUG
//			LogInfo("* [%6d][%s] on_danger_remove",Device.dwTimeGlobal,*cName());
#endif
			m_best_cover_actual			= false;
		}
...
{
#ifdef _DEBUG
//	LogInfo("* [%6d][%s] cover is blocked",Device.dwTimeGlobal,*cName());
#endif
	m_best_cover_actual					= false;
}
