...
#include "../../../xrSound/sound.h"          // ref_sound for environment.h
#include "../../../xrEngine/environment.h"
#include "../../../xrEngine/fmesh.h"
#include "../../../build_config_defines.h"
#include "../../xrRender/xrRender_console.h"  // ps_r__Tree_*
...
void FTreeVisual::Load		(const char* N, IReader *data, u32 dwFlags)
{
	...
	R_ASSERT			(data->find_chunk(OGF_TREEDEF2));
	{
		...
		//LogInfo("hemi[%f / %f], sun[%f / %f]",c_scale.hemi,c_bias.hemi,c_scale.sun,c_bias.sun);
	}
