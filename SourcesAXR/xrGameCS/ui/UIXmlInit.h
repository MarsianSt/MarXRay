...
//	static bool InitLabel				(CUIXml& xml_doc, LPCSTR path, int index, CUILabel* pWnd);
	...
	static bool InitText				(CUIXml& xml_doc, LPCSTR path, int index, IUITextControl* pWnd);
	...
	static bool Init3tButtonEx			(CUIXml& xml_doc, LPCSTR path, int index, CUI3tButtonEx* pWnd);
...
//	static bool InitColor				(CUIXml& xml_doc, XML_NODE* node, u32 &color);
	...
	static bool InitMultiText			(CUIXml& xml_doc, LPCSTR path, int index, CUIStatic* pWnd);
	static bool InitTexture				(CUIXml& xml_doc, LPCSTR path, int index, IUIMultiTextureOwner* pWnd);
	static bool InitTexture				(CUIXml& xml_doc, LPCSTR path, int index, IUISingleTextureOwner* pWnd);
	static bool InitOptionsItem			(CUIXml& xml_doc, LPCSTR paht, int index, CUIOptionsItem* pWnd);
//	static u32	GetARGB					(CUIXml& xml_doc, LPCSTR path, int index);
